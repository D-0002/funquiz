...
const HARD_MIN_POINTS_IF_CORRECT = 3;
...
export class HardPage implements OnInit, OnDestroy {
  questions: Question[] = [
  ...
  maximumPossibleScore: number = QUESTIONS_PER_GAME * HARD_BASE_POINTS_PER_QUESTION;
